...
public abstract class AbstractIndex implements FileSerializable{
    public Map<Integer, String> getDocIdToDocPathMapping() {
        return docIdToDocPathMapping;
    }

    public Map<AbstractTerm, AbstractPostingList> getTermToPostingListMapping() {
    ...
    public AbstractIndex(Map<Integer, String> docIdToDocPathMapping, Map<AbstractTerm, AbstractPostingList> termToPostingListMapping) {
